        ...
        stage('Pushing to ECR') {
            steps{
                script {
                    ...
                    sh 'docker tag geolocation_ecr_rep:latest aws_account_id.dkr.ecr.region.amazonaws.com/geolocation_ecr_rep:latest'
                    sh 'docker push 076892551558.dkr.ecr.us-east-1.amazonaws.com/geolocation_ecr_rep'
                }
            }
        }
    }
